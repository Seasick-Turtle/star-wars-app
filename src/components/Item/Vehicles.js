  ...
  return (
    <main>
      <section className='section__component'>
        ...
        <p><strong>Consumables:</strong> {vehicleData.consumables}</p>
        <p><strong>Cargo Capacity:</strong> {vehicleData.cargo_capacity}</p>
        <p><strong>Max Atmosphering Speed:</strong> {vehicleData.max_atmosphering_speed}</p>
        <p><strong>Manufacturer:</strong> {vehicleData.manufacturer}</p>
        <p><strong>Vehicle Class:</strong> {vehicleData.vehicle_class}</p>
        <p><strong>Cost (In Credits):</strong> {vehicleData.cost_in_credits}</p>
